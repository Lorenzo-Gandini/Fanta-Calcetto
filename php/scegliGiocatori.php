<h1 class="title"><strong>Scegli i giocatori della tua squadra!</strong></h1>
<br />
<?php
	include_once "php/funzioni.php";

	$utente = $_SESSION["email"];
    $fantacash = $_SESSION["fantacash"];
    $nPor = 2;
    $nDif = 3;
    $nCen = 3;
    $nAtt = 3;

        $sql = "SELECT nome, squadra, prezzo, ruolo FROM giocatore";
            ...
            <div class="row">
                ...
                <div class="col-9 list-scrolling"  data-spy="scroll" >
                    <div data-target="#list-giocatori" data-offset="0" class="scrollspy-example">
                         <br /><h4 id="list-item-portieri">PORTIERI</h4>
                            ...
                            <br />
                        <br /><h4 id="list-item-difensori">DIFENSORI</h4>
                          <table class="table text-center">
                          ...
                          <br /><h4 id="list-item-centrocampisti">CENTROCAMPISTI</h4>
                           <table class="table text-center">
                          ...
                          <br /><h4 id="list-item-attaccanti">ATTACCANTI</h4>
                            <table class="table text-center">
